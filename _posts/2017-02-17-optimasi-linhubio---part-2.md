...
<img src="{{ site.url }}/img/nsetyo.png" class="img-responsive" alt="situs sty">  
...
<img src="{{ site.url }}/img/css-delivery.png" class="img-responsive" alt="css delivery">  

Sepertinya sudah lebih baik mari kita uji performa situs ini  

<img src="{{ site.url }}/img/performance-linhub.png" class="img-responsive" alt="performance-linhub">  

Wow sungguh mengedjoetkan sekali, mari kita uji situs [nsetyo](https://nsetyo.com)  

<img src="{{ site.url }}/img/performance-nsetyo.png" class="img-responsive" alt="performance-nsetyo">  
...
<img src="{{ site.url }}/img/performance-rizaumami.png" class="img-responsive" alt="performance-rizaumami">  
...
<img src="{{ site.url }}/img/new-linhub.png" class="img-responsive" alt="performance-baru">  
